    ...
    <div className="flex flex-col gap-4">      
      <div className="flex gap-3 items-center">
        ...
        <div className="px-3 w-72 py-1.5 border border-white/10 rounded-lg text-sm flex items-center gap-3">
          ...
          <input className="bg-transparent flex-1 outline-none border-0 p-0 h-auto text-sm" type="text" placeholder="Buscar participantes..." />
        </div>
      </div>
            ...
            {Array.from({ length: 10 }).map((_, i) => {
              return (
                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4 text-sm text-zinc-300">
                    <button className="border border-white/10 rounded bg-black/20 p-1.5">
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-sm text-zinc-300 text-right" colSpan={3}>
                ...
                <div className="flex gap-1.5">
                  <button className="border border-white/10 rounded bg-white/10 p-1.5">
